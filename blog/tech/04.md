...
![Nodejs官网下载界面使用](https://fastly.jsdelivr.net/gh/MornZe/Blog-Static-Resource@main/images/Screenshot_2025-03-02-16-49-37-81_a87fd7db6caa850b517aa6fa9d2fcd0e.jpg)
...
![Github主页截图](https://fastly.jsdelivr.net/gh/MornZe/Blog-Static-Resource@main/images/IMG_20250302_172731.jpg)
...
![Netlify控制台截图](https://fastly.jsdelivr.net/gh/MornZe/Blog-Static-Resource@main/images/Screenshot_2025-03-02-17-54-19-74_df198e732186825c8df26e3c5a10d7cd.jpg)
接下来就慢慢等待部署成功。
## 绑定自定义域名
进入网站面板，点击`Domain management`，添加一个新域名，然后把你的域名解析到它分配的`*.netlify.app`，然后域名板块下方`SSL/TLS certificate`面板部署SSL，把强制SSL打开。
![SSL/TLS certificate控制台面板](https://fastly.jsdelivr.net/gh/MornZe/Blog-Static-Resource@main/images/Screenshot_2025-03-02-18-05-27-61_df198e732186825c8df26e3c5a10d7cd.jpg)
